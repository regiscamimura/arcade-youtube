...
import arcade_youtube
from arcade_youtube.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_youtube)


@tool_eval()
def youtube_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="youtube Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to youtube tools. "
